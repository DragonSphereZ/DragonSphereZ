...
public class ComplexCircle2 extends ParticleEffect {
	...
	public ComplexCircle2(String idName, Object center, List<Player> players) {
		...
		if (!effectManager.isActive(idName))  {
			idTask = Bukkit.getServer().getScheduler().runTaskTimer(plugin, new Runnable() {
				...
				public void run() {
					...
					location.display(ComplexCircle2.this);
